...
export default function DeleteTaskModel(props: DeleteTaskModelProps) {
  const { handleDeleteTask, deleteTaskModel, setDeleteTaskModel, title } =
    props;
  return (
      ...
      <div className="w-[480px] space-y-4 h-[230px] rounded-lg p-6 bg-[#2B2C37]">
        ...
        <div className="gap-x-6 flex itme-center">
          <button
            ...
            className="w-[46%]  py-2 duration-300 hover:opacity-65   text-white bg-red-500 rounded-full"
          >
            Delete
          </button>
          <button className="w-[46%]  py-2 duration-300 hover:opacity-65  text-[#635fc7] bg-white rounded-full">
            Cancel
          </button>
        </div>
      </div>
